Vue.component("managerForFacility",{
    data : function(){
        return{
    ...
    methods : {
        addUser : function(event){
            axios.post('/rest/adminHomePage/createFacility/managerForFacility/create',this.managerDTO).then(response => alert("Uspesno pravljenje"))
